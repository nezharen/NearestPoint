...
static const char qt_meta_stringdata_Dialog[] = {
    "Dialog\0\0x\0randomPoints(int)\0emitAndClose()\0"
};
...
void Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->randomPoints((*reinterpret_cast< const int(*)>(_a[1]))); break;
        case 1: _t->emitAndClose(); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Dialog::randomPoints(const int & _t1)
{
